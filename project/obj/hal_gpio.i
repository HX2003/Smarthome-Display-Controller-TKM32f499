...
#line 23 "..\\Hal_lib\\src\\HAL_gpio.c"
...
#line 24 "..\\Hal_lib\\src\\HAL_gpio.c"
...
#line 61 "..\\Hal_lib\\src\\HAL_gpio.c"
...
void GPIO_DeInit(GPIO_TypeDef* GPIOx)
{
  ...
  {
  case ((((uint32_t)0x40000000) + 0x00020000) + 0x0000):
    RCC_AHBPeriphClockCmd(((uint32_t)0x00000001), ENABLE);
    RCC_AHBPeriphClockCmd(((uint32_t)0x00000001), DISABLE);
    break;
  case ((((uint32_t)0x40000000) + 0x00020000) + 0x0400):
    RCC_AHBPeriphClockCmd(((uint32_t)0x00000002), ENABLE);
    RCC_AHBPeriphClockCmd(((uint32_t)0x00000002), DISABLE);
    break;
  case ((((uint32_t)0x40000000) + 0x00020000) + 0x0800):
    RCC_AHBPeriphClockCmd(((uint32_t)0x0000004), ENABLE);
    RCC_AHBPeriphClockCmd(((uint32_t)0x0000004), DISABLE);
    break;
  case ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00):
    RCC_AHBPeriphClockCmd(((uint32_t)0x0000008), ENABLE);
    RCC_AHBPeriphClockCmd(((uint32_t)0x0000008), DISABLE);
    break;
  default:
    break;
  }
...
void GPIO_Init(GPIO_TypeDef* GPIOx, GPIO_InitTypeDef* GPIO_InitStruct)
{
  ...
  if(GPIO_InitStruct->GPIO_Pin>>16)  
  {
    ...
    tmpreg = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000))->CRH_EXT;
    for (pinpos = 0x00; pinpos < 0x08; pinpos++)
    {
      pos = ((uint32_t)0x01) << pinpos;
    ...
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000))->CRH_EXT = tmpreg;
  }
}
...
void GPIO_StructInit(GPIO_InitTypeDef* GPIO_InitStruct)
{
  ...
  GPIO_InitStruct->GPIO_Pin  = ((uint32_t)0xFFFFFF);
...
void GPIO_SetBits(GPIO_TypeDef* GPIOx, uint32_t GPIO_Pin)
{
  ...
  ((void)0);
  ((void)0);
  if(GPIO_Pin>((uint16_t)0x8000))((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000))->BSRR_EXT=GPIO_Pin>>16;
	else
  GPIOx->BSRR = GPIO_Pin;
  ...
  ((void)0);
	...
	if(GPIO_Pin>>16)  
	{
		...
		for(i=0;i<8;i++)
		{
			if(temp&0x01)
			{
				((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000))->AFRH_EXT &= ~((uint32_t)0xF << ((uint32_t)(i<<2)));     
				((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000))->AFRH_EXT |= ((uint32_t)GPIO_AF << ((uint32_t)(i<<2)));
			}
			temp = temp>>1;
		}
	}
	if(GPIO_Pin&0XFF00)  
		{
			...
			for(i=0;i<8;i++)
			{
				if(temp&0x01)
				{
					GPIOx->AFRH &= ~((uint32_t)0xF << ((uint32_t)(i<<2)));     
	...
	if(GPIO_Pin&0XFF)  
		{
			for(i=0;i<8;i++)
			{
				if(temp&0x01)
				{
					GPIOx->AFRL &= ~((uint32_t)0xF << ((uint32_t)(i<<2)));     
