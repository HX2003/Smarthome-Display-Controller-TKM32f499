...
#line 2 "..\\CMSIS_and_startup\\sys.c"
#line 3 "..\\CMSIS_and_startup\\sys.c"

void  RemapVtorTable(void)
{ 
	int i;
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB1ENR |= 1<<13;
	
    for(i = 0;i<90;i++)
    { 
        NVIC_DisableIRQ((IRQn_Type)i); 
    }
	((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR = 0;
	((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR |= 0x1<<29;
	for(i = 0;i < 512;i+=4)
	*(u32*)(0X20000000 + i) = *(u32*)(0X70020000+i);

}

void  AI_Responder_enable(void)
{
  ((AI_Responder_TypeDef*) ((((uint32_t)0x40000000) + 0x10000) + 0x7400))->ADDR1= 0x70807040;

  ((AI_Responder_TypeDef*) ((((uint32_t)0x40000000) + 0x10000) + 0x7400))->ADDR1 = 0;
  ((AI_Responder_TypeDef*) ((((uint32_t)0x40000000) + 0x10000) + 0x7400))->CCR &= ~(0x3<<3);
  ((AI_Responder_TypeDef*) ((((uint32_t)0x40000000) + 0x10000) + 0x7400))->CCR |= 1;
  while((((AI_Responder_TypeDef*) ((((uint32_t)0x40000000) + 0x10000) + 0x7400))->SR & 0x3) != 2);
}
void  AI_Responder_disable(void)
{
    ((AI_Responder_TypeDef*) ((((uint32_t)0x40000000) + 0x10000) + 0x7400))->CCR &= ~1;
...
{ 
	...
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->APB2ENR|=1<<14;  						
	((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->EXTICR[BITx/4]&=~(0x000F<<EXTOFFSET);
	((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->EXTICR[BITx/4]|=GPIOx<<EXTOFFSET;	
	
	((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3C00))->IMR|=1<<BITx;					
	if(TRIM&0x01)((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3C00))->FTSR|=1<<BITx;	
	if(TRIM&0x02)((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3C00))->RTSR|=1<<BITx;	
} 	
...
{ 
	...
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->APB1ENR|=1<<28;
	((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CSR|=1<<8;     
	((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CR|=1<<2;      
	((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CR|=1<<1;      
	WFI_SET();			
}	     

void Sys_Soft_Reset(void)
{   
	((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->AIRCR =0X05FA0000|(u32)0x04;	  
} 		 
...
void TK499_NVIC_Init(u8 NVIC_PreemptionPriority,u8 NVIC_SubPriority,u8 NVIC_Channel,u8 NVIC_Group)	 
{
	...
	temp&=0xf;								
	((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ISER[NVIC_Channel/32]|=1<<NVIC_Channel%32;
	((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->IP[NVIC_Channel]|=temp<<4;				
}

void TK80_IRQHandler(void)
{
    if(((TK80_TypeDef *) ((0x60000000) + 0x00000000))->SR & 0x1)
    {
    
    }
    if(((TK80_TypeDef *) ((0x60000000) + 0x00000000))->SR & 0x2)
    {
    
    }
    if(((TK80_TypeDef *) ((0x60000000) + 0x00000000))->SR & 0x4)
    {
    
    }
    if(((TK80_TypeDef *) ((0x60000000) + 0x00000000))->SR & 0x8)
    {
    
    }
    ((TK80_TypeDef *) ((0x60000000) + 0x00000000))->SR |= 0;
}
