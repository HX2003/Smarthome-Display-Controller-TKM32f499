...
#line 5 "bsp\\Timer\\timer.h"
#line 1 ".\\bsp\\UART\\UART.h"
#line 2 ".\\bsp\\UART\\UART.h"
...
#line 6 "bsp\\Timer\\timer.h"
void TIM8_Config(u16 arr,u16 psc);
void TIM3_Config(u16 arr,u16 psc);
void TIM10_Config(u16 arr,u16 psc);

#line 2 "bsp\\Timer\\timer.c"
#line 3 "bsp\\Timer\\timer.c"

void TIM8_Config(u16 arr,u16 psc)
{
   TIM_TimeBaseInitTypeDef TIM_TimeBaseStructure;
   NVIC_InitTypeDef NVIC_InitStruct;        
   RCC_APB1PeriphClockCmd(((uint32_t)0x00000001<<5),ENABLE); 
   ...
   NVIC_InitStruct.NVIC_IRQChannel = TIM8_IRQn;  
...
void TIM3_Config(u16 arr,u16 psc)
{
   TIM_TimeBaseInitTypeDef TIM_TimeBaseStructure;
   NVIC_InitTypeDef NVIC_InitStruct;        
   RCC_APB1PeriphClockCmd(((uint32_t)0x00000001<<0),ENABLE); 
   TIM_TimeBaseStructure.TIM_Period = arr; 
   TIM_TimeBaseStructure.TIM_Prescaler =psc; 
   TIM_TimeBaseStructure.TIM_ClockDivision = ((uint16_t)0x0000); 
   TIM_TimeBaseStructure.TIM_CounterMode = ((uint16_t)0x0000);  
...
void TIM10_Config(u16 arr,u16 psc)
{
   TIM_TimeBaseInitTypeDef TIM_TimeBaseStructure;
   NVIC_InitTypeDef NVIC_InitStruct;        
   RCC_APB1PeriphClockCmd(((uint32_t)0x00000001<<7),ENABLE); 
   TIM_TimeBaseStructure.TIM_Period = arr; 
   TIM_TimeBaseStructure.TIM_Prescaler =psc; 
   TIM_TimeBaseStructure.TIM_ClockDivision = ((uint16_t)0x0000); 
   TIM_TimeBaseStructure.TIM_CounterMode = ((uint16_t)0x0000);  
   TIM_TimeBaseInit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1C00)), &TIM_TimeBaseStructure); 
        
   TIM_ITConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1C00)),((uint16_t)0x0001),ENABLE ); 
   ...
   TIM_Cmd(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1C00)), ENABLE);  
}
void TIM10_IRQHandler(void)
{
   if (TIM_GetITStatus(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1C00)), ((uint16_t)0x0001)) != RESET)
	{	
		printf("\n TIM10_IRQn \n");
	}
	TIM_ClearITPendingBit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1C00)), ((uint16_t)0x0001)); 
}
