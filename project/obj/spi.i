...
#line 3 "bsp\\SPI\\spi.c"
#line 1 "bsp\\SPI\\spi.h"



#line 16 "bsp\\SPI\\spi.h"

void SPIM_Init(SPI_TypeDef* SPIx,unsigned short spi_baud_div);


#line 4 "bsp\\SPI\\spi.c"
...
void SPIM_CSLow(SPI_TypeDef* SPIx)
{
	...
	SPI_CSInternalSelected(SPIx, ((uint16_t)0xfffe),ENABLE);
}
...
void SPIM_CSHigh(SPI_TypeDef* SPIx)
{
	...
	SPI_CSInternalSelected(SPIx, ((uint16_t)0xfffe),DISABLE);
}
...
void SPIM_TXEn(SPI_TypeDef* SPIx)
{
	...
	SPI_BiDirectionalLineConfig(SPIx, ((uint16_t)0x0008));
}
...
void SPIM_TXDisable(SPI_TypeDef* SPIx)
{
	...
	SPI_BiDirectionalLineConfig(SPIx, ((uint16_t)0xfff7));
}
...
void SPIM_RXEn(SPI_TypeDef* SPIx)
{
	...
	SPI_BiDirectionalLineConfig(SPIx, ((uint16_t)0x0010));
}
...
void SPIM_RXDisable(SPI_TypeDef* SPIx)
{
	...
	SPI_BiDirectionalLineConfig(SPIx, ((uint16_t)0xffef));
}
...
unsigned int SPIMReadWriteByte(SPI_TypeDef* SPIx,unsigned char tx_data)
{
	...
	while (1)
	{
		if(SPI_GetFlagStatus(SPIx, ((uint16_t)0x0002)))	
		{
...
void SPI_RegRW()
{
	...
	RCC_APB1PeriphClockCmd(((uint32_t)0x00004000), ENABLE);  
		...
		printf("SPI1->TXREG=0x%x\r\n",  ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x5000))->TXREG);  
		printf("SPI1->RXREG=0x%x\r\n",  ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x5000))->RXREG); 
		printf("SPI1->CSTAT=0x%x\r\n",  ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x5000))->CSTAT); 																	 
		printf("SPI1->INTSTAT=0x%x\r\n",((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x5000))->INTSTAT);																
		printf("SPI1->INTEN =0x%x\r\n", ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x5000))->INTEN );  																		 
		printf("SPI1->INTCLR=0x%x\r\n", ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x5000))->INTCLR);  																			
		printf("SPI1->GCTL  =0x%x\r\n", ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x5000))->GCTL  );  																 
		printf("SPI1->CCTL =0x%x\r\n",  ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x5000))->CCTL );   																	 
		printf("SPI1->SPBRG=0x%x\r\n",  ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x5000))->SPBRG);    																 
		printf("SPI1->RXDNR=0x%x\r\n",  ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x5000))->RXDNR);    																	 
		printf("SPI1->SCSR =0x%x\r\n",  ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x5000))->SCSR ); 
	
		printf("SPI2->TXREG=0x%x\r\n",  ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x5400))->TXREG);  
		printf("SPI2->RXREG=0x%x\r\n",  ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x5400))->RXREG); 
		printf("SPI2->CSTAT=0x%x\r\n",  ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x5400))->CSTAT); 																					
		printf("SPI2->INTSTAT=0x%x\r\n",((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x5400))->INTSTAT);																				
		printf("SPI2->INTEN =0x%x\r\n", ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x5400))->INTEN );  																				
		printf("SPI2->INTCLR=0x%x\r\n", ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x5400))->INTCLR);  																				
		printf("SPI2->GCTL  =0x%x\r\n", ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x5400))->GCTL  );  																				
		printf("SPI2->CCTL =0x%x\r\n",  ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x5400))->CCTL );   																				
		printf("SPI2->SPBRG=0x%x\r\n",  ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x5400))->SPBRG);    																				
		printf("SPI2->RXDNR=0x%x\r\n",  ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x5400))->RXDNR);    
																						
		printf("SPI2->SCSR =0x%x\r\n",  ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x5400))->SCSR );  
}
...
void SPIM_Init(SPI_TypeDef* SPIx,unsigned short spi_baud_div)
{
	...
	GPIO_InitTypeDef  GPIO_InitStructure;
		...
		RCC_APB2PeriphClockCmd(((uint32_t)0x00200000), ENABLE);  
	...
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000))->AFRL &= 0;
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000))->AFRL |= 0x555000ee;

	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000))->BSRR = 0x4;

	SPI_InitStructure.SPI_Mode = ((uint16_t)0x0004);
	SPI_InitStructure.SPI_DataSize = ((uint16_t)0x0000);
	SPI_InitStructure.SPI_DataWidth = ((uint16_t)0x0008);

	SPI_InitStructure.SPI_CPOL = ((uint16_t)0x0002);    		
	SPI_InitStructure.SPI_CPHA = ((uint16_t)0x0000);  
	
	SPI_InitStructure.SPI_NSS = ((uint16_t)0x0000);
...
void SPIMSendByte(SPI_TypeDef* SPIx,unsigned char tx_data)
{
	...
	while (1)
	{
		...
		if(SPI_GetFlagStatus(SPIx, ((uint16_t)0x0001)))	
		{
			break;
		}
	}
