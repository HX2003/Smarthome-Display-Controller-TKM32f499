#line 1 "bsp\\LED\\led.c"
#line 1 "bsp\\LED\\led.h"
...
void LED_Init(void)
{
	...
	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)), ((uint16_t)0x0100));	
}
