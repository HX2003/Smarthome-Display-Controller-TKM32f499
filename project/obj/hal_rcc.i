...
#line 114 "..\\Hal_lib\\src\\HAL_rcc.c"
...
{	
	...
	RCC_PLLCmd(DISABLE);
	RCC_PLLConfig(((uint32_t)0x00400000),PLL_DN);
	RCC_PLLCmd(ENABLE);
...
void RCC_DeInit(void)
{
  ...
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CFGR &= (uint32_t)0xF8FF0000;
  ...
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CFGR &= (uint32_t)0xFF80FFFF;
...
void RCC_HSEConfig(uint32_t RCC_HSE)
{
  ...
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CR &= ((uint32_t)0xFFFEFFFF);
  ...
  case ((uint32_t)0x00040000):
    ...
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CR |= ((uint32_t)0x00040000) | ((uint32_t)0x00010000);
    break;
...
void RCC_HSICmd(FunctionalState NewState)
{
  ...
  if(NewState==ENABLE)
  {
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CR |= 0x01;
  }
  else
  {
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CR &= 0xfffffffe;
  }
}
...
void RCC_PLLDMDNConfig(uint32_t RCC_PLLSource, uint32_t RCC_PLLDN,uint32_t RCC_PLLDP, uint32_t RCC_PLLDM)
{
  ...
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->PLLCFGR = tmpreg0;
...
void RCC_PLLConfig(uint32_t RCC_PLLSource, uint32_t RCC_PLLMul)
{
 ...
 if(RCC_PLLMul==((uint32_t)0x00000000))
  {
		TK499_PLL_FACTOR = 2;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000001, 0x00000000,0x00000000); 
  }
  if(RCC_PLLMul==((uint32_t)0x00040000))
  {
		TK499_PLL_FACTOR = 3;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000002, 0x00000000,0x00000000);
  }
  if(RCC_PLLMul==((uint32_t)0x00080000))
  {
		TK499_PLL_FACTOR = 4;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000003, 0x00000000,0x00000000);
  }
  if(RCC_PLLMul==((uint32_t)0x000C0000))
  {
		TK499_PLL_FACTOR = 5;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000013, 0x00000001,0x00000001);
  }
  if(RCC_PLLMul==((uint32_t)0x00100000))
  {
		TK499_PLL_FACTOR = 6;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000005, 0x00000000,0x00000000);
  }
  if(RCC_PLLMul==((uint32_t)0x00140000))
  {
		TK499_PLL_FACTOR = 7;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000006, 0x00000000,0x00000000);
  }
  if(RCC_PLLMul==((uint32_t)0x00180000))
  {
		TK499_PLL_FACTOR = 8;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000007, 0x00000000,0x00000000);
  }
  if(RCC_PLLMul==((uint32_t)0x001C0000))
  {
		TK499_PLL_FACTOR = 9;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000008, 0x00000000,0x00000000);
  }
  if(RCC_PLLMul==((uint32_t)0x00200000))
  {
		TK499_PLL_FACTOR = 10;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000009, 0x00000000,0x00000000);
  }
  if(RCC_PLLMul==((uint32_t)0x00240000))
  {
		TK499_PLL_FACTOR = 11;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x0000000a, 0x00000000,0x00000000);
  }
  if(RCC_PLLMul==((uint32_t)0x00280000))
  {
		TK499_PLL_FACTOR = 12;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x0000000b, 0x00000000,0x00000000);
  }
  if(RCC_PLLMul==((uint32_t)0x002C0000))
  {
		TK499_PLL_FACTOR = 13;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x0000000c, 0x00000000,0x00000000);
  }
  if(RCC_PLLMul==((uint32_t)0x00300000))
  {
		TK499_PLL_FACTOR = 14;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x0000000d, 0x00000000,0x00000000);
  }
  if(RCC_PLLMul==((uint32_t)0x00340000))
  {
		TK499_PLL_FACTOR = 15;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x0000000e, 0x00000000,0x00000000);
  }
  if(RCC_PLLMul==((uint32_t)0x00380000))
  {
		TK499_PLL_FACTOR = 16;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x0000000f, 0x00000000,0x00000000);
  }
	if(RCC_PLLMul==((uint32_t)0x003C0000))
  {
		TK499_PLL_FACTOR = 17;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000010, 0x00000000,0x00000000);
  }
	if(RCC_PLLMul==((uint32_t)0x00400000))
  {
		TK499_PLL_FACTOR = 18;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000011, 0x00000000,0x00000000);
  }
	if(RCC_PLLMul==((uint32_t)0x004C0000))
  {
		TK499_PLL_FACTOR = 19;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000012, 0x00000000,0x00000000);
  }
	if(RCC_PLLMul==((uint32_t)0x00500000))
  {
		TK499_PLL_FACTOR = 20;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000013, 0x00000000,0x00000000);
  }
	if(RCC_PLLMul==((uint32_t)0x00540000))
  {
		TK499_PLL_FACTOR = 21;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000014, 0x00000000,0x00000000);
  }
	if(RCC_PLLMul==((uint32_t)0x00580000))
  {
		TK499_PLL_FACTOR = 22;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000015, 0x00000000,0x00000000);
  }	
	if(RCC_PLLMul==((uint32_t)0x005C0001))
  {
		TK499_PLL_FACTOR = 23;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000016, 0x00000000,0x00000000);
  }
		if(RCC_PLLMul==((uint32_t)0x00600002))
  {
		TK499_PLL_FACTOR = 24;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000017, 0x00000000,0x00000000);
  }
		if(RCC_PLLMul==((uint32_t)0x00680003))
  {
		TK499_PLL_FACTOR = 25;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000018, 0x00000000,0x00000000);
  }
		if(RCC_PLLMul==((uint32_t)0x006C0004))
  {
		TK499_PLL_FACTOR = 26;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000019, 0x00000000,0x00000000);
  }
		if(RCC_PLLMul==((uint32_t)0x00700005))
  {
		TK499_PLL_FACTOR = 27;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000020, 0x00000000,0x00000000);
  }
		if(RCC_PLLMul==((uint32_t)0x00780006))
  {
		TK499_PLL_FACTOR = 28;
    RCC_PLLDMDNConfig(RCC_PLLSource, 0x00000021, 0x00000000,0x00000000);
  }
}
...
void RCC_PLLCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CR |= 0x01000000;
  }
  else
  {
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CR &= 0xfeffffff;
  }
}
...
void RCC_SYSCLKConfig(uint32_t RCC_SYSCLKSource)
{
  ...
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CFGR = tmpreg;
	if(RCC_SYSCLKSource == ((uint32_t)0x00000002))
	{
		if(TK499_PLL_FACTOR&0x10000)
		{
				TK499_SYS_CLK = (TK499_PLL_FACTOR&0xff)*((uint32_t)8000000);
		}
		else
		{
				TK499_SYS_CLK = (TK499_PLL_FACTOR&0xff)*((uint32_t)48000000/4);
		}
	}
	else if(RCC_SYSCLKSource == ((uint32_t)0x00000001))
	{
		TK499_SYS_CLK = ((uint32_t)8000000);
	}
	else
	{
		TK499_SYS_CLK = ((uint32_t)48000000/6);
	}
}
...
void RCC_ITConfig(uint8_t RCC_IT, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CIR |= ((uint32_t)RCC_IT)<<8;
  }
  else
  {
...
void RCC_USBCLKConfig(uint32_t RCC_USBCLKSource)
{
  ...
  ((void)0);
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CFGR |= RCC_USBCLKSource;
}
...
void RCC_LSEConfig(uint8_t RCC_LSE)
{
  ...
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->BDCR &= ~((uint32_t)((uint8_t)0x01));
  ...
  case ((uint8_t)0x01):
    ...
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->BDCR |= ((uint8_t)0x01);
    break;
    
  case ((uint8_t)0x04):
     
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->BDCR |= ((uint8_t)0x04) | ((uint8_t)0x01);
    break;            
...
void RCC_LSICmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CSR |= 0x00000001;
  }
  else
  {
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CSR &= 0xfffffffe;
  }
}
...
void RCC_RTCCLKConfig(uint32_t RCC_RTCCLKSource)
{
  ...
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->BDCR |= RCC_RTCCLKSource;
}
...
void RCC_RTCCLKCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->BDCR |= 0x00008000;
  }
  else
  {
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->BDCR &= 0xffff7fff;
  }
}
void getSystemClock(u32 *sysclk)
{
  u32 tempreg0 = ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CFGR; 
  u32 tempreg1;
  u8  dn,dp,dm;
  ...
  {
    tempreg1 = ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->PLLCFGR;
    dn = (tempreg1 >> 6) & 0x7F;
    dn ++;
    dp = (tempreg1 >> 4) & 0x3;
    if(dp == 0)
...
void RCC_GetClocksFreq(RCC_ClocksTypeDef* RCC_Clocks)
{
  ...
  {
  case 0x00:   
    RCC_Clocks->SYSCLK_Frequency = ((uint32_t)48000000/6);
    break;
  case 0x04:   
  ...
  tmp = ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CFGR & ((uint32_t)0x00000700);
  tmp = tmp >> 8;
  presc = APBAHBPrescTable[tmp];
   
  RCC_Clocks->PCLK1_Frequency = RCC_Clocks->HCLK_Frequency >> presc;
   
  tmp = ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CFGR & ((uint32_t)0x00003800);
  tmp = tmp >> 11;
  presc = APBAHBPrescTable[tmp];
   
  RCC_Clocks->PCLK2_Frequency = RCC_Clocks->HCLK_Frequency >> presc;
   
  tmp = ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CFGR & ((uint32_t)0x0000C000);
  tmp = tmp >> 14;
...
void RCC_AHBPeriphClockCmd(uint32_t RCC_AHBPeriph, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB1ENR |= RCC_AHBPeriph;
  }
  else
  {
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB1ENR &= ~RCC_AHBPeriph;
...
void RCC_BackupResetCmd(FunctionalState NewState)
{
  ...
  ((void)0);
  *(volatile uint32_t *) (((uint32_t)0x42000000) + (((((((uint32_t)0x40000000) + 0x00020000) + 0x3800) - ((uint32_t)0x40000000)) + 0x20) * 32) + (0x10 * 4)) = (uint32_t)NewState;
}
...
void RCC_ClockSecuritySystemCmd(FunctionalState NewState)
{
  ...
  if(NewState==ENABLE)
  {
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CR |= (uint32_t)0x00080000;
  }
  else
  {
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CR &= (uint32_t)0xfff7ffff;
  }
}
...
void RCC_MCOConfig(uint8_t RCC_MCO)
{
  ...
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CFGR |= (RCC_MCO<<24);
}
...
void RCC_ClearITPendingBit(uint8_t RCC_IT)
{
  ...
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->CIR |= (uint32_t)RCC_IT<<16;
}
