...
#line 23 "..\\Hal_lib\\src\\HAL_exti.c"
...
void EXTI_DeInit(void)
{
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3C00))->IMR = 0x00000000;
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3C00))->EMR = 0x00000000;
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3C00))->RTSR = 0x00000000; 
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3C00))->FTSR = 0x00000000; 
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3C00))->PR = 0x001FFFFF;
}
...
void EXTI_Init(EXTI_InitTypeDef* EXTI_InitStruct)
{
  ...
  tmp = (uint32_t)((((uint32_t)0x40000000) + 0x10000) + 0x3C00);  
  
  if (EXTI_InitStruct->EXTI_LineCmd != DISABLE)
  {
     
    ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3C00))->IMR &= ~EXTI_InitStruct->EXTI_Line;
    ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3C00))->EMR &= ~EXTI_InitStruct->EXTI_Line;
    
    tmp += EXTI_InitStruct->EXTI_Mode;
    *(volatile uint32_t *) tmp |= EXTI_InitStruct->EXTI_Line;
    
     
    ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3C00))->RTSR &= ~EXTI_InitStruct->EXTI_Line;
    ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3C00))->FTSR &= ~EXTI_InitStruct->EXTI_Line;
...
void EXTI_GenerateSWInterrupt(uint32_t EXTI_Line)
{
  ...
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3C00))->SWIER |= EXTI_Line;
}
...
FlagStatus EXTI_GetFlagStatus(uint32_t EXTI_Line)
{
  ...
  if ((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3C00))->PR & EXTI_Line) != (uint32_t)RESET)
  {
    bitstatus = SET;
  }
  else
...
void EXTI_ClearFlag(uint32_t EXTI_Line)
{
  ...
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3C00))->PR = EXTI_Line;
}
...
ITStatus EXTI_GetITStatus(uint32_t EXTI_Line)
{
  ...
  enablestatus =  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3C00))->IMR & EXTI_Line;
  if (((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3C00))->PR & EXTI_Line) != (uint32_t)RESET) && (enablestatus != (uint32_t)RESET))
  {
    bitstatus = SET;
  }
  else
